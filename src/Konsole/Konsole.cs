...
namespace Konsole
{
    ...
    public static class Konsole
    {
        ...
        public static KonsoleComponent ConsoleInstance { get; internal set; }
        ...
        private static void Internal_IntegrateConsole(RectTransform parent, IntegrationOptions options)
        {
            ...
            var consoleOwnerObject = new GameObject("[RootKonsole]", typeof(RectTransform), typeof(CanvasGroup), typeof(KonsoleComponent))
            {
                layer = uiLayerMask
            };
            ...
            // KonsoleComponent
            ConsoleInstance = consoleOwnerObject.GetComponent<KonsoleComponent>();
